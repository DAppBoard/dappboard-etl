...
SELECT
COUNT(*) as count_of_trades, ftoken.name as fname, stoken.name as sname,  ftoken.symbol as fsym, stoken.symbol as ssym, ftoken.address as faddress, stoken.address as saddress, COUNT(DISTINCT(maker, taker)) AS count_of_traders
 FROM dapp_0x
